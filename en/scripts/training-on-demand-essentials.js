  var BCLS = (function() {
    ...
    switch (siteLanguage) {
        case "en":
            playerButtonLabelText = BCLSbuttons.buttonLabels.en.showPlayer;
            topicsButtonLabelText = BCLSbuttons.buttonLabels.en.showTopics;
            break;
        case "de":
            playerButtonLabelText = BCLSbuttons.buttonLabels.de.showPlayer;
            topicsButtonLabelText = BCLSbuttons.buttonLabels.de.showTopics;
            break;
        case "es":
            playerButtonLabelText = BCLSbuttons.buttonLabels.es.showPlayer;
            topicsButtonLabelText = BCLSbuttons.buttonLabels.es.showTopics;
            break;
        case "fr":
            playerButtonLabelText = BCLSbuttons.buttonLabels.fr.showPlayer;
            topicsButtonLabelText = BCLSbuttons.buttonLabels.fr.showTopics;
            break;
        case "ja":
            playerButtonLabelText = BCLSbuttons.buttonLabels.ja.showPlayer;
            topicsButtonLabelText = BCLSbuttons.buttonLabels.ja.showTopics;
            break;
        case default:
            playerButtonLabelText = BCLSbuttons.buttonLabels.en.showPlayer;
            topicsButtonLabelText = BCLSbuttons.buttonLabels.en.showTopics;

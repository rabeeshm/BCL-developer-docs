var BCLSmain = (function ($, window, console, document, Handlebars, PLAYER_UI_NAV_DATA, hljs) {
    "use strict";
    var $precode = $("pre code"),
        ...
        productName,
        sectionName,
        productColors = {"index": "#333333", "video-cloud": "#dd712e", "once": "#85a93e", "perform": "#35498D"},
    ...
    */
    ...
    buildBreadCrumbs = function () {
        ...
        if (exists(product)) {
            if (product === "index") {
                ...
                str += "<li><a href=\"//docs.brightcove.com/en/" + product + "/index.html\">" + PLAYER_UI_NAV_DATA[product].name + "</a></li>";
            }
        }
    ...
    createNavigation = function () {
        var data = PLAYER_UI_NAV_DATA[section],
            item,
            i,
            max,
            navHTML = "",
        ...
        processDropdown = function (items) {
            ...
            if (product !== "index") {
                titleStr += product + "/index.html\"><img src=\"" + PLAYER_UI_NAV_DATA[product].image + "\"/></a>";
            } else {
        ...
        createLandingPageSections = function () {
            var data = PLAYER_UI_NAV_DATA[section],
                ...
                kMax,
                item,
                landingPageBlockTemplateStart = "<div class=\"large-3 small-12 columns\" style=\"overflow-x:hidden\"><h2>{{name}}</h2>",
                landingPageSubMenuTemplateStart = "<div><h4>{{name}}</h4>",
                ...
                str = "";
            bclslog(sections);
            bclslog("defined: " + exists(sections));
            if (exists(sections)) {
                data = data.items;
                max = data.length;
                for (i = 0; i < max; i++) {
        ...
        createSubsectionLandingPageSections = function () {
            var dataIndex = findObjectInArray(PLAYER_UI_NAV_DATA[section].items, "name", subsectionName),
                data = PLAYER_UI_NAV_DATA[section].items[dataIndex],
                $top = $("#top"),
                i,
                max,
                item,
        ...
        getSection = function () {
            ...
            if (pathArray[3] === "index.html") {
                ...
                section = "player-ui";
                sectionName = PLAYER_UI_NAV_DATA[section].name;
                subsection = null;
                createLandingPageSections();
            } else {
                section = "player-ui";
...
})($, window, console, document, Handlebars, PLAYER_UI_NAV_DATA, hljs);

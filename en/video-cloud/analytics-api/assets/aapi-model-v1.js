var aapi_model = {
    ...
    combinations: {
        ...
        account__city: {dimensions: ["account", "city"], from: "2011-01-01", fields: []},
        ...
        account__player__country: {dimensions: ["account", "player", "country"], from: "2011-01-01", fields: []},
        account__device_os: {dimensions: ["account", "device_os"], from: "2011-01-01", fields: []},
        account__device_type: {dimensions: ["account", "device_type"], from: "2011-01-01", fields: []},
        ...
        account__referrer_domain: {dimensions: ["account", "referrer_domain"], from: "2012-10-01", fields: []},
        ...
        account__source_type: {dimensions: ["account", "source_type"], from: "2012-10-01", fields: []},
        account__search_terms: {dimensions: ["account", "search_terms"], from: "2012-10-01", fields: []},
        ...
        video__referrer_domain: {dimensions: ["video", "referrer_domain"], from: "2012-10-01", fields: []},
        video__source_type: {dimensions: ["video", "source_type"], from: "2012-10-01", fields: []},
        ...
        account__destination_path: {dimensions: ["account", "destination_path"], from: "2014-03-03", fields: []},
        account__destination_domain: {dimensions: ["account", "destination_domain"], from: "2014-03-03", fields: []},
        ...
        video__destination_domain: {dimensions: ["video", "destination_domain"], from: "2014-03-03", fields: []},

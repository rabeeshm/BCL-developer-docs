(function() {
    var player,
        ...
        $overlayImage,
        $playButton,
        overlayContent = "<div id=\"overlayContent\" style=\"cursor:pointer;width:auto;height:50px;position:absolute;top:90px;left:144px;padding:4px;\"><img id=\"overlayImage\" src=\"http://docs.brightcove.com/en/video-cloud/smart-player-api/samples/assets/PlayBlock.png\" /></div><div id=\"mediaControls\" style=\"position:absolute;top:238px;left:0;width:100%;height:30px;background-color:#000000;opacity:.7;z-index:99;\"> <img id=\"bclPlayButton\" class=\"paused\" style=\"cursor:pointer;z-index:101;margin-top:5px\" src=\"http://docs.brightcove.com/en/video-cloud/smart-player-api/samples/assets/bcl-play-button.png\"/> <span id=\"videoPosition\" style=\"position:relative;left:25px;bottom:10px;color:#DFE1E2 !important;font-size:12px;\"></span><div style=\"position:absolute;top:12px;left:110px;height:6px;width:320px;background-color:#777978;\"><div id=\"positionIndicator\" style=\"background-color:#b8bdbf;background-image:-webkit-gradient(linear,leftcenter,rightcenter,from(#b8bdbf),to(#fefefe));background-image:-webkit-linear-gradient(left,#b8bdbf,#fefefe);background-image:-moz-linear-gradient(left,#b8bdbf,#fefefe);background-image:-o-linear-gradient(left,#b8bdbf,#fefefe);background-image:-ms-linear-gradient(left,#b8bdbf,#fefefe);background-image:linear-gradient(left,#b8bdbf,#fefefe);filter:progid:DXImageTransform.Microsoft.gradient(GradientType=1,StartColorStr='#b8bdbf',EndColorStr='#fefefe');width:0;height:6px;\"></div></div><span id=\"videoLength\" style=\"color:#DFE1E2;font-size:12px;float:right;padding-top:8px;padding-right:5px\"></span></div>",
        overlayPaused = "http://docs.brightcove.com/en/video-cloud/smart-player-api/samples/assets/ResumeBlock.png",
        overlayComplete = "http://docs.brightcove.com/en/video-cloud/smart-player-api/samples/assets/ReplayBlock.png",
        overlayError = "http://docs.brightcove.com/en/video-cloud/smart-player-api/samples/assets/errorBlock.png";
    setUpOverlay = function () {
      ...
      // get references to parts we'll need to modify
      ...
      // overlay content is initially shown
      showOverlayContent();
    ...
    // the functions below change the content for the overlay
    setButtonPlaying = function () {
      $playButton.attr("src", "http://docs.brightcove.com/en/video-cloud/smart-player-api/samples/assets/bcl-pause-button.png");
      $playButton.removeClass("paused");
      $playButton.addClass("playing");
    };
    setButtonPaused = function () {
      $playButton.attr("src", "http://docs.brightcove.com/en/video-cloud/smart-player-api/samples/assets/bcl-play-button.png");
    ...
    // player has loaded, so get the player and module references
